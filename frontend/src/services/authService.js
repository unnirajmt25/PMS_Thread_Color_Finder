...
// Exported so other modules (colorService) can stamp "who made this
// change" onto records without duplicating the identity string.
export const ADMIN_USERNAME = "unniraj.chathukutty@idynamics.com";
